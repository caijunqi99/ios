...
{
    UIView *HeaderView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, GPScreenWidth, tableFooterHeight)];
...
{
    UIView *HeaderView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, GPScreenWidth, tableHeaderHeight)];
    HeaderView.backgroundColor = _HeaderAndFooterBackgroundColor ? : kCOLOR_Gray_TableBG;
