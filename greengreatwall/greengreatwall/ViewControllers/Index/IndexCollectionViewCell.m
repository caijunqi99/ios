...
-(void)layoutSubviews
{
    ...
    [_labelPriceOrigin setText:[NSString stringWithFormat:@"¥%@",_dic[@"goods_promotion_price"]]];
    [_labelPriceOrigin addDeletelineColor:[UIColor grayColor] toText:[NSString stringWithFormat:@"¥%@",_dic[@"goods_promotion_price"]]];
