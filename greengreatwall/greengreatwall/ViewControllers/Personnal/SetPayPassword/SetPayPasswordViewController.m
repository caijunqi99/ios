...
- (void)configInterface
{
    ...
    [self settingNavTitle:@"重置支付密码" WithNavTitleColor:[UIColor blackColor]];
...
{
    HPWeak;
    [HPNetManager POSTWithUrlString:HostMemberaccountmodify_paypwd_step4 isNeedCache:NO parameters:[NSDictionary dictionaryWithObjectsAndKeys:[HPUserDefault objectForKey:@"token"],@"key",_textFieldVerify.text,@"auth_code",_textFieldPassword.text,@"password",_textFieldPasswordConfirm.text,@"confirm_password", nil] successBlock:^(id response) {
