//
//  StoreCategoryContentViewController.m
//  greengreatwall
//
...
@interface StoreCategoryContentViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation StoreCategoryContentViewController
...
- (void)configInterface
{
    ...
    [_tableView setFrame:CGRectMake(0, 0, GPScreenWidth , GPScreenHeight - kStatusBarHeight - kTabBarHeight - 100)];
}
