...
- (void)headerRereshing
{
    ...
    _strParameter = @"1";
    [HPNetManager POSTWithUrlString:HostStorelistindex isNeedCache:NO parameters:[NSDictionary dictionaryWithObjectsAndKeys:_strParameter,@"page",@"0",@"cate_id", nil] successBlock:^(id response) {
