...
@implementation InstanceCollectionViewCell

-(void)layoutSubviews
{
    [_imageViewLogo sd_setImageWithURL:[NSURL URLWithString:_dic[@"goods_image"]] placeholderImage:defaultImage];
    
    [_labelTitle setText:[NSString stringWithFormat:@"%@",_dic[@"goods_name"]]];
    [_labelPrice setText:[NSString stringWithFormat:@"%@",_dic[@"goods_promotion_price"]]];
    
    [_labelPriceOrigin setText:[NSString stringWithFormat:@"%@",_dic[@"goods_price"]]];
    [_labelPriceOrigin addDeletelineColor:[UIColor grayColor] toText:_dic[@"goods_price"]];
