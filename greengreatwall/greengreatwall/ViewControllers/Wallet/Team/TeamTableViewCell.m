...
-(void)layoutSubviews
{
    ...
    [_labelMobile setFrame:RectWithScale(CGRectMake(40, 10, 360, 50), GPCommonLayoutScaleSizeWidthIndex)];
    [_labelMobile setFont:FontMediumWithSize(16)];
    
    [_labelexppoints setFrame:RectWithScale(CGRectMake(400, 10, 150, 50), GPCommonLayoutScaleSizeWidthIndex)];
    [_labelexppoints setFont:FontRegularWithSize(16)];
    
    [_labellevel setFrame:RectWithScale(CGRectMake(550, 10, 100, 50), GPCommonLayoutScaleSizeWidthIndex)];
    [_labellevel setFont:FontRegularWithSize(16)];
    
    [_labeladdtime setFrame:RectWithScale(CGRectMake(650, 10, 390, 50), GPCommonLayoutScaleSizeWidthIndex)];
