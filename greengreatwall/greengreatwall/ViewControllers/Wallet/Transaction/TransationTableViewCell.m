...
@implementation TransationTableViewCell

-(void)layoutSubviews
{
    [_labelTime setText:[NSString stringWithFormat:@"%@",_dic[@"tl_add_time_text"]]];
    [_labelDescribe setText:[NSString stringWithFormat:@"%@",_dic[@"tl_desc"]]];
